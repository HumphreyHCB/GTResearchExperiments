...
public class JProfilerDumpsCSVSummary {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //    e.g. "GTExperiment2bWithSafepoint/JProfilerData"
        String directoryPath = "GTExperiment2bWithSafepoint/JProfilerDataXML";  

        // 2) Output CSV file
        String outputCsv = "GTExperiment2bWithSafepoint/Readers/Output/JProfiler_Summary.csv";
