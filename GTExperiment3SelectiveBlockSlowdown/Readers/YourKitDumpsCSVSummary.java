...
public class YourKitDumpsCSVSummary {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String inputDir = "GTExperiment3SelectiveBlockSlowdown/YourKitDataTXT";

        // Output CSV file
        String outputCsv = "GTExperiment3SelectiveBlockSlowdown/Readers/Output/YourKit_Summary.csv";
